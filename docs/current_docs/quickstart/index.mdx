...
Note that Dagger requires a container runtime. This can be [Docker](https://docs.docker.com/engine/install/), but you can also use [Podman](https://docs.dagger.io/integrations/528320/podman/), nerdctl, or other Docker-like systems.
